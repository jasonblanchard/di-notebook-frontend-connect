  ...
  return (
    <div className="lg:max-w-lg mx-auto">
      <button
        ...
        className="mt-24 block w-full h-96 rounded-lg border-2 border-dashed border-neutral-300 p-28 text-center hover:border-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-2"
      >
        <PlaceholderText />
